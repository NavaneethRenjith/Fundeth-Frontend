...
export default () => (
  <AnimationRevealPage>
    ...
    <Testimonial
      ...
      description="Here are what some of our amazing customers are saying about us."
      testimonials={[
        {
          imageSrc:
          ...
          quote:
            "Absolutely love these guys! I definitely recommend!",
          customerName: "Muhammed Razeen",
          customerTitle: "CEO, Lifeboat Inc."
        },
        {
          imageSrc:
